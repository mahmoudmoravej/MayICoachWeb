...
export function FirstPageFooter({
  title,
  description,
  socials,
  menus,
  ...
  title: string;
  description: string;
  socials: { color: "white" | "black"; name: string; path: string }[];
...
FirstPageFooter.displayName = "/src/widgets/layout/footer.jsx";
